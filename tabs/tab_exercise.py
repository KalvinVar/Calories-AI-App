...
EXERCISE_DATABASE = {
    ...
    "🏋️ Strength Training": {
        "Bench Press": {"met": 5.0, "icon": "🏋️"},
        "Squat": {"met": 6.0, "icon": "🏋️‍♂️"},
        "Deadlift": {"met": 6.0, "icon": "🏋️‍♂️"},
        "Overhead Press": {"met": 5.0, "icon": "🏋️"},
        "Barbell Rows": {"met": 5.0, "icon": "🏋️"},
        "Lat Pulldown": {"met": 4.5, "icon": "🏋️"},
        "Bicep Curls": {"met": 3.5, "icon": "💪"},
        "Leg Press": {"met": 5.0, "icon": "🏋️"},
        "Leg Curls / Extensions": {"met": 3.5, "icon": "🏋️"},
        "Lunges (weighted)": {"met": 5.0, "icon": "🏋️‍♂️"},
        "Calf Raises": {"met": 3.5, "icon": "🏋️"},
        "Cable Flyes / Crossover": {"met": 3.5, "icon": "🏋️"},
        "Dumbbell Shoulder Raises": {"met": 3.5, "icon": "💪"},
...
EXERCISE_ROM = {
    ...
    "Bicep Curls": 0.35,
    "Leg Press": 0.40,
    "Leg Curls / Extensions": 0.40,
    "Lunges (weighted)": 0.50,
    "Calf Raises": 0.15,
    "Cable Flyes / Crossover": 0.50,
    "Dumbbell Shoulder Raises": 0.35,
...
def render_exercise_logger(app, user_weight):
    ...
    if category == "🏋️ Strength Training":
        strength_descriptions = {
            "Bench Press": "🏋️ **Chest, shoulders, triceps** — Flat, incline, or decline barbell/dumbbell press. The classic upper body push movement. ROM ~50cm.",
            "Squat": "🏋️ **Quads, glutes, hamstrings, core** — Back squat, front squat, or goblet squat. One of the most effective compound lifts for lower body. ROM ~65cm.",
            "Deadlift": "🏋️ **Full posterior chain** — Conventional, sumo, or Romanian deadlift. Engages back, glutes, hamstrings, and grip. ROM ~60cm.",
            "Overhead Press": "🏋️ **Shoulders, triceps, upper chest** — Standing or seated barbell/dumbbell press overhead. Great for shoulder strength. ROM ~50cm.",
            "Barbell Rows": "🏋️ **Back, biceps, rear delts** — Bent-over barbell or dumbbell row. Builds a thick, strong back. ROM ~45cm.",
            "Lat Pulldown": "🏋️ **Lats, biceps, upper back** — Cable machine pulldown to chest. Similar muscles to pull-ups but adjustable weight. ROM ~60cm.",
            "Bicep Curls": "💪 **Biceps, forearms** — Barbell, dumbbell, or cable curls. Isolation exercise for arm development. ROM ~35cm.",
            "Leg Press": "🏋️ **Quads, glutes, hamstrings** — Machine-based leg press at various foot positions. Safer alternative to squats for heavy loads. ROM ~40cm.",
            "Leg Curls / Extensions": "🏋️ **Hamstrings (curls) or Quads (extensions)** — Machine isolation exercises for targeted leg development. ROM ~40cm.",
            "Lunges (weighted)": "🏋️ **Quads, glutes, balance** — Walking, stationary, or reverse lunges with dumbbells or barbell. Great for unilateral strength. ROM ~50cm.",
            "Calf Raises": "🏋️ **Calves (gastrocnemius, soleus)** — Standing or seated calf raises. Short range of motion (~15cm) but high load potential.",
            "Cable Flyes / Crossover": "🏋️ **Chest, front delts** — Cable crossover or dumbbell flyes. Isolation for chest with constant tension. ROM ~50cm.",
            "Dumbbell Shoulder Raises": "💪 **Side/front/rear delts** — Lateral raises, front raises, or reverse flyes. Isolation for shoulder caps. ROM ~35cm.",
